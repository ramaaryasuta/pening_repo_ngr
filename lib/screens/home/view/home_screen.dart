...
import 'package:pening_repository_ngr/screens/auth/providers/auth_provider.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  late AuthenticationProvider authP;
  ...
  void initState() {
    ...
    authP = context.read<AuthenticationProvider>();
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      if (authP.user == null) return;
      authP.notify();
      await homeP.getAllPosts(authP.user!.uid);
    });
  }
        ...
        children: [
          Tooltip(
            ...
            child: FloatingActionButton(
              onPressed: () {
                homeP.getAllPosts(authP.user!.uid);
              },
